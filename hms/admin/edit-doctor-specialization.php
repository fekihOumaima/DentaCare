...
{
$sql=$mysqli->query("update  doctorSpecilization set specilization='".$_POST['doctorspecilization']."', updationDate='$currentTime'where id='$id'");
...
$id=intval($_GET['id']);
	$sql=$mysqli->query("select * from doctorSpecilization where id='$id'");
