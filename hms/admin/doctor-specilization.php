...
{
$sql=$mysqli->query("insert into doctorSpecilization(specilization) values('".$_POST['doctorspecilization']."')");
$_SESSION['msg']="Doctor Specialization added successfully !!";
}

if(isset($_GET['del']))
		  {
			      $mysqli->query("delete from doctorSpecilization where id = '".$_GET['id']."'");
